<div class="titulo-linea mt-2">
  <h2><i class="far fa-user"></i>Perfil Veterinario</h2>
  <hr class="sidebar-divider">
</div>
<div class="row perfil-veterinario">
  <?php
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          ...
          <div class="profile-img-cli text-center mb-4">
            <img class="rounded-circle" src="<?php  echo SERVERURL;?><?php echo $campos['vetFotoUrl'];?>" alt="foto-veterinario">
            <h5 class="mt-2"><b><?php echo $campos['vetNombre']." ".$campos['vetApellido'] ; ?></b></h5>
          </div>
          <!-- X profile-img-cli x -->
          <!-- inf. contacto -->
          <input type="hidden" name="dni_veterinario_perfil" value="<?php echo $campos['vetDni'];?>">
          <div class="inf-contacto d-flex flex-column">
            <span><i class="fas fa-phone fa-sm fa-fw"></i><?php echo $campos['vetTelefono'];?></span>
            <br>
          ...
          <h3 class="sub-titulo-panel">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mb-4">
                <span>NIT/CI: <br><b><?php echo $campos['vetDni'];?></b></span>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4">
                <span>Nombre: <br><b><?php echo $campos['vetNombre'];?></b></span>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4">
                <span>Apellido: <br><b><?php echo $campos['vetApellido'];?></b></span>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4">
                <span>Genero: <br><b><?php echo $campos['vetGenero'];?></b></span>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4">
                <span>Especialidad: <br><b><?php echo $campos['vetEspecialidad'];?></b></span>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4">
                  <span>Domicilio: <br><b><?php echo $campos['vetDomicilio'];?></b></span>
              </div>                       
            </div>
  ...
  <!-- ----------- HISTORIAL FACTURADO --------  -->
  <div class="col-lg-12">
    <div class="panel_historial_factura intro mb-4" urlajax="<?php  echo SERVERURL;?>ajax/veterinarioAjax.php" >
      <!-- header -->

(function($) {
    ...
    */
    ...
    function reset_radio_avatar(avatar,form){
      $(`input[name="avatar-${avatar}"]`).prop('checked',false);
        var ruta_avatar_va = $(`#form-add-${form} input[name='avatar-${avatar}']:radio`).is(':checked');
        // console.log("avatares en false: "+ruta_avatar_va);  
    }
  
    reset_radio_avatar("cliente","Cliente");
  
    /** codigo a ejecutar cuando se detecta un cambio de archivo input file
    *  
    */
  
    function archivofotosubir(boton,form,avatar){ 
      boton.change(function(){   
        // avalar radio checked
        var avatar_select = $(`#form-add-${form} input[name='avatar-${avatar}']:radio`).is(':checked'); 
        // si es true
        if(avatar_select){
          // console.log("avatar en true: "+avatar_select);
          reset_radio_avatar();
          validar_formato_img(boton);            
        }else{
          validar_formato_img(boton);
    ...
    archivofotosubir(btnUploadCliente,"Cliente","cliente");
  
    /* Click al seleccionar un avartar para cliente
    * 
    */
    function inputClick(avatar,form,foto){
  
      $(`input[name=avatar-${avatar}]`).click(function(){
        ...
        if(ruta_avatar_va){
          ...
          var ruta_avatar_value = $(`input:radio[name=avatar-${avatar}]:checked`).val();
          // console.log("seleccionado avatar value : "+ruta_avatar_value);
          var ruta_avatar_db = $(`input:radio[name=avatar-${avatar}]:checked`).data(foto);
    ...
    inputClick("cliente","Cliente","fotocliente");
  
    reset_radio_avatar("veterinario","Veterinario");
  
    var btnUploadVeterinario = $("#archivo_foto_subir");
    archivofotosubir(btnUploadVeterinario,"Veterinario","veterinario");
  
    inputClick("veterinario","Veterinario","fotoveterinario");
   ...
   /*==================================================================*/
    ...
    /*==================================================================*/
    // limpiar radios avatar
    reset_radio_avatar("mascota","Mascota");
  
    /** codigo a ejecutar cuando se detecta un cambio de archivo input file
    *  
    */
    var btnUploadMascota = $("#archivo_foto_subir");
    archivofotosubir(btnUploadMascota,"Mascota","mascota");
  
    /* Click al seleccionar un avartar para mascota
    * 
    */
  
    inputClick("mascota","Mascota","fotomascota");
